...
export default function ParentNotices() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">School Notices</h1>
        <p className="text-muted-foreground">Announcements and updates from the administration.</p>
      </div>
      ...
      <Tabs value={filter} onValueChange={setFilter} className="w-full">
        <TabsList>
          ...
          <TabsTrigger value="fee">Fee/Admin</TabsTrigger>
        </TabsList>
      </Tabs>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Please be informed about the {notice.title.toLowerCase()}. As a parent, we request you to make a note of this. Detailed instructions will follow via email if necessary.
                    </p>
